...
public class ParserTestBits {
	private static void doTest( byte[] test, String exp) {
		FCompound act = ParserAtBits.parseAsCompound( test);
	...
	public void testParse2() {
		byte[] test = { 10, 0, 0, 3, 0, 6, 69, 110, 101, 114, 103, 121, 0, 6, 26, -128, 0
		};
	...
	public void testParse3() {
		byte[] test = { 10, 0, 0, 8, 0, 5, 116, 105, 116, 108, 101, 0, 23, 84, 71, 46, 112, 101, 114, 115, 111, 110, 97, 108, 116, 105, 116, 108, 101, 46, 115, 101, 101, 107, 101, 114, 0
		};
	...
	public void testParse5() {
		byte[] test = { 10, 0, 0, 3, 0, 4, 82, 101, 99, 118, 0, 0, 0, 80, 1, 0, 9, 82, 83, 67, 111, 110, 116, 114, 111, 108, 1, 1, 0, 6, 70, 97, 99, 105, 110, 103, 3, 3, 0, 6, 69, 110, 101, 114, 103, 121, 0, 6, 26, -128, 7, 0, 9, 83, 105, 100, 101, 67, 97, 99, 104, 101, 0, 0, 0, 6, 1, 2, 2, 2, 2, 2, 3, 0, 4, 83, 101, 110, 100, 0, 0, 0, 80, 0
		};
	...
	public void testParse7() {
		byte[] test = { 10, 0, 0, 9, 0, 4, 101, 110, 99, 104, 10, 0, 0, 0, 2, 2, 0, 3, 108, 118, 108, 0, 6, 2, 0, 2, 105, 100, 0, 34, 0, 2, 0, 3, 108, 118, 108, 0, 6, 2, 0, 2, 105, 100, 0, 35, 0, 0
		};
	...
	public void testParse8() {
		byte[] test = { 10, 0, 0, 3, 0, 4, 83, 101, 110, 100, 0, 0, 3, 32, 1, 0, 6, 70, 97, 99, 105, 110, 103, 3, 3, 0, 6, 69, 110, 101, 114, 103, 121, 0, 30, -124, -128, 3, 0, 4, 82, 101, 99, 118, 0, 0, 3, 32, 7, 0, 9, 83, 105, 100, 101, 67, 97, 99, 104, 101, 0, 0, 0, 6, 1, 2, 2, 2, 2, 2, 1, 0, 9, 82, 83, 67, 111, 110, 116, 114, 111, 108, 1, 0
		};
