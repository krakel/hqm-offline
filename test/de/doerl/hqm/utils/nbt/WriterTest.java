...
public class WriterTest {
	private static void doTest( String test, byte[] exp) {
		try {
	...
	public void testParse2() {
		String test = "=COMPOUND( Energy=INT(400000) )";
		byte[] exp = {
	...
	public void testParse3() {
		String test = "=COMPOUND( title=STRING('TG.personaltitle.seeker') )";
		byte[] exp = {
	...
	public void testParse5() {
		String test = "=COMPOUND( Recv=INT(80), RSControl=BYTE(1), Facing=BYTE(3), Energy=INT(400000), SideCache=BYTE-ARRAY( 1, 2, 2, 2, 2, 2 ), Send=INT(80) )";
		byte[] exp = {
	...
	public void testParse7() {
		String test = "=COMPOUND( ench=LIST( COMPOUND( lvl=SHORT(6), id=SHORT(34) ), COMPOUND( lvl=SHORT(6), id=SHORT(35) ) ) )";
		byte[] exp = {
	...
	public void testParse8() {
		String test = "=COMPOUND( Send=INT(800), Facing=BYTE(3), Energy=INT(2000000), Recv=INT(800), SideCache=BYTE-ARRAY( 1, 2, 2, 2, 2, 2 ), RSControl=BYTE(1) )";
		byte[] exp = {
