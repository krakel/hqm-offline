...
class ReportRewards extends ABundleAction implements IRefreshListener, Runnable {
	...
	public static final FileFilter FILTER = new FileNameExtensionFilter( "reward file", "txt");
	...
	private static void writeReward( Map<String, Integer> map, OutputStream os) throws IOException {
